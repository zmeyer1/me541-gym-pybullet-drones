...
class BaseAviary(gym.Env):
    ...
    def __init__(self,
        ...
        if self.DRONE_MODEL == DroneModel.CF2X or self.DRONE_MODEL == DroneModel.CABLE :
    ...
    def _dynamics(self,
        ...
        if self.DRONE_MODEL==DroneModel.CF2X or self.DRONE_MODEL==DroneModel.RACE or self.DRONE_MODEL==DroneModel.CABLE:
    ...
    def _addObstacles(self):
        ...
        clothId = p.loadSoftBody("cloth_z_up.obj", basePosition = [-1,0,2], scale = 0.5, mass = 1., useNeoHookean = 0, useBendingSprings=1,useMassSpring=1, springElasticStiffness=40, springDampingStiffness=.1, springDampingAllDirections = 1, useSelfCollision = 0, frictionCoeff = .5, useFaceContact=1)
